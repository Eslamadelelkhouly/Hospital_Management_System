    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('Scheduled', 'Scheduled'), ('Completed', 'Completed'), ('Pending', 'Pending'), ('Cancelled', 'Cancelled')], max_length=10)),
            ],
        ),
        migrations.CreateModel(
            name='Billing',
            fields=[
                ...
                ('biling_id', shortuuid.django_fields.ShortUUIDField(alphabet=1234567890, length=6, max_length=10, prefix='')),
