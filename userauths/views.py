    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            if user is not None:
                ...
                messages.error(request,"Authenticated Faield , please try agian!")
    else:
...
def login_view(request):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            try:
                user_instance = userauths_models.User.objects.get(email=email,password=password , is_active=True)
